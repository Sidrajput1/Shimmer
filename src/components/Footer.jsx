                ...
                online presence.
                    ...
                    <div className="grid grid-cols-1 gap-8 lg:col-span-2 sm:grid-cols-2 lg:grid-cols-4">
                        ...
                        <div>
                            ...
                            <nav className="flex flex-col mt-4 space-y-2 text-sm text-gray-500">
                                <a className="hover:opacity-75" href='#'>Domain & Hosting </a>
                                <a className="hover:opacity-75" href='#'> Website Building  </a>
                                <a className="hover:opacity-75" href='#'> Software Building </a>
                                <a className="hover:opacity-75" href='#'> Web Apps </a>
                        ...
                        <div>
                            ...
                            <nav className="flex flex-col mt-4 space-y-2 text-sm text-gray-500">
                                ...
                                <a className="hover:opacity-75" href='#'> Call:-0612-352245 </a>
                                <a className="hover:opacity-75" href='#'> 9431442634 </a>
                                <a className="hover:opacity-75" href='#'>  </a>
                            </nav>
                        </div>
                    </div>
