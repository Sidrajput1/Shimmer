    ...
    <div className="bg-black h-screen">
      ...
      {/* <div className="bg-black text-gray-100 px-8 py-12">
        <form>
          ...
          <div className="max-w-screen-xl mt-24 px-8 grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 py-16 mx-auto bg-gray-900 text-gray-100 rounded-lg shadow-lg">
              ...
              <div>
                ...
                <div className="text-gray-700 mt-8">
                  ...
                  <span className="underline">
                    <a
                      target="_BLANK"
                      href="https://veilmail.io/irish-irish-geoff"
                    >
          ...
          <div className="-mx-4 flex flex-wrap lg:justify-between">
            <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
              <div className="mb-12 max-w-[570px] lg:mb-0">
                ...
                <h2 className="mb-6 text-[32px] font-bold uppercase text-orange-700 brightness-150 dark:text-white sm:text-[40px] lg:text-[36px] xl:text-[40px]">
                ...
                <div className="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div className="w-full">
                    ...
                    Building no- 367,opp,central,Bank of india, Lohiya Nagar,Kankarbagh,patna-800020
                    </p>
                  </div>
                </div>
              ...
              <div className="relative rounded-lg bg-white p-8 shadow-lg dark:bg-dark-2 sm:p-12">
                <form onSubmit={handleSubmit}>
                  ...
                  <div>
                    <button
                      type="submit"
                      className="w-full rounded border border-primary bg-orange-700 p-3 text-white transition hover:bg-opacity-90"
                    >
                      Send Message
                    </button>
                  </div>
