      ...
      <div className="max-w-screen-xl z-50 flex flex-wrap items-center justify-between mx-auto p-4">
        <a href="/" className="flex items-center hover:animate-pulse space-x-3 rtl:space-x-reverse">
          <img
            ...
            alt="Shimmer Logo"
          />
          <span className="self-center md:text-3xl text-2xl font-bold whitespace-nowrap text-orange-600">
            Shimmer <span className="text-blue-700 ">Softech</span>
           
          </span>
          <span className="relative top-6 text-xs  text-gray-900 font-bold right-56">A unit of Shimmer utility pvt. ltd </span>
        ...
        <div
          ...
          id="navbar-dropdown"
        >
          <ul className="flex flex-col z-50 font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            <li>
              <a
                href="/home"
                className="block navel py-2 px-3 text-white bg-blue-700 rounded md:bg-transparent md:text-orange-600 font-extrabold  md:p-0  dark:bg-blue-600 md:dark:bg-transparent"
                aria-current="page"
              >
                Home
              </a>
            ...
            <li className="relative">
              <button
                ...
                className="flex navel items-center justify-between w-full py-2 px-3 text-orange-600 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 md:w-auto dark:text-white md:dark:hover:text-blue-500 dark:focus:text-white dark:border-gray-700 dark:hover:bg-gray-700 md:dark:hover:bg-transparent"
              >
                Services{" "}
                <svg
              ...
              <div
                ...
                } absolute left-0 top-10 mt-2 z-10  font-normal bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600`}
              >
                <ul
                  className="py-2 text-sm text-gray-900 dark:text-gray-400"
            ...
            <li>
              <a
                href="/about"
                className="block navel py-2 px-3 text-orange-600 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent"
              >
                About Us
              </a>
            </li>
